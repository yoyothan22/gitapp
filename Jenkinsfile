pipeline {
    ...
    stage('Push') {
        steps {
            ...
            sudo git remote set-url origin https://yoyothan22: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@github.com/yoyothan22/gitapp.git
